...
export default function WalkPromoCard({ campaignId = "default" }: { campaignId?: CampaignId }) {
  ...
  return (
    <section className="relative bg-dark-surface rounded-none lg:rounded-section px-5 py-9 md:px-7 md:py-10 lg:px-10 lg:py-12 overflow-hidden">
      ...
      <p className="text-[0.6rem] uppercase tracking-[0.2em] text-accent/40 font-medium relative">{copy.eyebrow}</p>
      <p className="text-[1.7rem] md:text-[1.9rem] text-dark-primary leading-[1.1] mt-2 relative">
        {copy.title}
      </p>
